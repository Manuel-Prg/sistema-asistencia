      ...
      <CardContent className="space-y-5 sm:space-y-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-xs sm:text-sm font-medium text-gray-600">Horas completadas</span>
          ...
          <div className="flex items-center justify-between text-xs sm:text-sm">
            <span className="text-gray-500">{percentage.toFixed(1)}% completado</span>
            {isComplete ? (
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4">
          ...
          <div className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 rounded-xl">
            ...
            <p className="text-2xl sm:text-3xl font-bold text-indigo-600">
              ...
              <span className="text-sm sm:text-base text-gray-500 font-normal ml-1">hrs</span>
            </p>
          </div>
          ...
          <div className="p-4 bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-100 rounded-xl">
            ...
            <p className="text-2xl sm:text-3xl font-bold text-purple-600">
              ...
              <span className="text-sm sm:text-base text-gray-500 font-normal ml-1">%</span>
            </p>
          </div>
        </div>
        ...
        <div className="pt-4 border-t border-gray-100">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs sm:text-sm text-gray-500">Tipo de programa</span>
            </div>
            <span className="inline-flex items-center px-3 py-1 rounded-full text-xs sm:text-sm font-medium bg-gradient-to-r from-indigo-100 to-purple-100 text-indigo-700 border border-indigo-200">
        ...
        {!isComplete && percentage > 75 && (
          <div className="p-3 bg-amber-50 border border-amber-200 rounded-lg">
            <p className="text-xs sm:text-sm text-amber-800 text-center font-medium">
        ...
        {isComplete && (
          <div className="p-3 bg-emerald-50 border border-emerald-200 rounded-lg">
            <p className="text-xs sm:text-sm text-emerald-800 text-center font-medium">
